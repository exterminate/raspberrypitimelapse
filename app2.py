...
os.system("avconv -r %s -i image%s.jpg -r %s -vcodec libx264 -crf 20 -g 15 -vf crop=2592:1458,scale=1280:720 timelapse.gif"%(FPS_IN,'%7d',FPS_OUT))
...
message.attach(filename="timelapse.gif")
